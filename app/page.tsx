  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 bg-zinc-50">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-3">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#033012]">Planificateur de taches</h1>
                  ...
                  {showSuccessors && (
                    <tr className="bg-white table-row-enter">
                      ...
                      {taskNames.map((tName, i) => {
                        ...
                        return (
                          <td key={i} className={`border border-gray-400 px-2 py-2 text-center text-sm ${vis ? "cell-fade-in" : ""}`}>
